...
class VoiceConnection extends EventEmitter {
    ...
    * @arg {Boolean} [options.inlineVolume=true] Whether to enable on-the-fly volume changing. Note that enabling this leads to increased CPU usage
    ...
    * @arg {Number} [volume=0.5] The desired volume. 0.0 is 0%, 1.0 is 100%, 2.0 is 200%, etc. It is not recommended to go above 2.0
    */
    setVolume(volume) {
    ...
    */
    ...
    toJSON() {
        var base = {};
        for(var key in this) {
            if(this.hasOwnProperty(key) && !key.startsWith("_") && !key.endsWith("Interval") && !key.endsWith("Timeout") && !~["nonce", "packetBuffer", "piper", "shard", "udpSocket", "ws"].indexOf(key)) {
                if(!this[key]) {
                    base[key] = this[key];
